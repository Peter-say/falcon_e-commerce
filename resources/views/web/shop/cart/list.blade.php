...
@section('contents')
    <div class="card">
        <div class="card-header">
            <div class="row justify-content-between">
                ...
                <div class="col-md-auto"><a class="btn btn-sm btn-outline-secondary border-300 me-2 shadow-none"
                        href="/"> <span class="fas fa-chevron-left me-1" data-fa-transform="shrink-4"></span>Continue
                        Shopping</a><a class="btn btn-sm btn-primary" href="checkout.html">Checkout</a></div>
            </div>
        </div>
        ...
        <div class="card-footer bg-light d-flex justify-content-end">
            ...
            </form><a class="btn btn-sm btn-primary" onclick="redirectToCheckout()">Checkout</a>
        </div>
    </div>
